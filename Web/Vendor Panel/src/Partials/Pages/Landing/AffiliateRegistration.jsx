...
const AffiliateRegistrationSchema = yup.object().shape({
  firstname: yup
    .string()
        ...
        <div className="w-100" style={{ maxWidth: "500px" }}>
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            <div className="row g-3">
              ...
              <div className="form-check fs-5 mx-2">
                <input
                  ...
                  {...register("consent")}
                />
                <label className="form-check-label fs-6" htmlFor="consent">
